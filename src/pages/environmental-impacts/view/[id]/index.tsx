...
import { getEnvironmentalImpactById } from 'apiSdk/environmental-impacts';
...
function EnvironmentalImpactViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('environmental_impact', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/environmental-impacts/edit/${data?.id}`} passHref legacyBehavior>
              <Button
